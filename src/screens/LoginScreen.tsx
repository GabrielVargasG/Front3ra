...
import { KeyboardAvoidingView, Platform, SafeAreaView, StyleSheet, View, useColorScheme, Keyboard, Image, Alert, StatusBar, TouchableWithoutFeedback, Text } from 'react-native';
                ...
                >
                    <SafeAreaView style={styles.safe}>
                        <View style={styles.container}>
                            ...
                            <Text style={{ color: (scheme === 'dark') ? 'white' : 'black' ,textAlign:'center', fontWeight:'bold', fontSize:18,marginBottom:15}}>Inicio de sesión</Text>
