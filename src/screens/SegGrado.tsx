  ...
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      <View style={styles.container}>
        <Text style={{color:(scheme === 'dark')?'white':'black',fontSize:25,marginBottom:20}}>Segundo Grado</Text>
        <FlatList
            data={niveles2}
            renderItem={({ item}) =>(
              item.completo ==="true" ?
              <View>
                <TouchableOpacity
                                style={{ 
                                    ...
                                    backgroundColor:(item.completo === "true") ? "#2a9d8f" : '#FFFFF'
                                }}
                ...
                <TouchableOpacity
                                style={{ 
                                    ...styles.botonGrande,
                                    // backgroundColor: '#5856D6'
                                    backgroundColor:(item.completo === "true") ? "#2a9d8f" : '#FF9427'
                                }}
                                onPress={() => {nivelA=item._id;
                                ira(item.action)}}
                            >
