...
import { dataN5 } from '../../../data/BasePreguntas';
...
var Images = [
    require('../images1/image17.png'),
    require('../images1/image18.png'),
    require('../images1/image19.png'),
    require('../images1/image20.png'),
    require('../images1/image21.png'),
];


interface Props extends StackScreenProps<any, any> { }

const Nivel5 = ({ navigation }: Props) => {
